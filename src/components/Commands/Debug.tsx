 ...
 * @param { Format.string, displayToast, Icons, Debug.fetchDebugArguments, mapItem }: Utility Functions that PronounDB uses.
...
const options = (channelName: string): any => {
    return {
        /**
         * @param {any} debug: The main command that will get run to display important information such as the version of @param PronounDB or the @param Discord build.
         */
        ...
        /**
         * @param {any} clearStores: Allows to user to clear all of their PronounDB stores.
         */
         clearStores: async function() {
             ...
             */
            const storeItems: any = JSON.parse(get("PronounDB", "state_store", null) as string) ?? []
             ...
             */
            set("PronounDB", "state_store", null);
        ...
        /**
         * @param {any} download: Allows the user to copy a unique download link of PronounDB to the clipboard.
         */
...
/**
 * Main command to send out debug information for @arg PronounDB.
...
export default {
     ...
     * @param {string?} displayName?: The name of the commmand that would actually display in-app. For example: @arg {</PronounDB:1>}
     * 
     ...
     * @param {string?} displayDescription?: The description of the commmand that would actually display in-app. For example: @arg {</PronounDB:1>}
     * 
     ...
     * @param options: List of options that the command will take. Example: @arg {/PronounDB type:Debug}
     */
    options: [{
        /**
